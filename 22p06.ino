...
// Framework setting
#define _DIST_TARGET 180           // [3040] 레일플레이트의 중간지점(목표지점=25.5cm)
#define _DIST_MIN 77                  //[3035] 측정 최소 거리
#define _DIST_MAX 306   //[3036] 측정 가능한 최대 거리
...
#define _DUTY_NEU 1500    //[3038] 레일 수평 서보 펄스폭
